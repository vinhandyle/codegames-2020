...
public class PointAndShoot : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0) && canShoot && GlobalControl.energyCurr > 0 && !MenuBackground.inMenu && !ReactorManage.open && GlobalControl.gunUnlocked && GlobalControl.reactor != "")
        {
